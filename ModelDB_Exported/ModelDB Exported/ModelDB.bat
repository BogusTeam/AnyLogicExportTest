...
%PATH_XJAL% -version:1.6+ -cp com.xj.anylogic.engine.jar;com.xj.anylogic.engine.nl.jar;model.jar;lib/ProcessModelingLibrary.jar;lib/postgresql-9.2-1004-jdbc4.jar;com.xj.anylogic.engine.sa.jar -Xmx64m modeldb.CustomExperiment %*
